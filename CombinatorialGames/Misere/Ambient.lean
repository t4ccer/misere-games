...
private lemma rightSeparatorLeftSet_finite {r h : G} (hh : IsShort h) :
  ...
  have := IsShort.finite_moves' Player.right hh
...
private lemma rightSeparatorLeftSet_short {r h : G} (h_root_short : IsShort r) (hh : IsShort h) :
  ...
  · exact h_root_short
  · exact Adjoint.short_rootedAdjoint h_root_short (IsShort.of_mem_moves hh hr.prop)
...
private lemma downlinkOptions_finite {r : G} {p : Player} {g h : G}
  ...
  have := IsShort.finite_moves' (-p) hg
  have := IsShort.finite_moves' (-p) hh
...
private lemma downlinkOptions_short {r : G} {p : Player} {g h : G} {z : moves (-p) h → G}
  ...
  · exact hz ⟨hp, hhp⟩
  · exact Adjoint.short_rootedAdjoint h_root_short (IsShort.of_mem_moves hg hgp)
