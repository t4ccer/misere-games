...
class PropertyX (A : GameForm → Prop) : Prop where
  prop_left {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h) (hpfh : IsPFree h)
    ...
    MisereOutcome (g + h) = .N
  prop_right {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h) (hpfh : IsPFree h)
    (hsg : IsShort g) (hsh : IsShort h)
    (hNg : MisereOutcome g = .N) (hNh : MisereOutcome h = .N)
...
omit [PropertyX A] in
private theorem lemma317_hr_ge_N {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (heq : NTippingPoint hsg = LTippingPoint hsh) :
    ∀ hr ∈ moves .right h, MisereOutcome (g + hr) ≥ .N := by
  intro hr hr_mem
  have hAhr : A hr := Hereditary.has_option hAh (isOption_iff_mem_union.2 (Or.inr hr_mem))
  have hpfhr : IsPFree hr := isPFree_of_mem_moves hpfh hr_mem
  ...
  · have hle : NTippingPoint (Short.of_mem_moves hsh hr_mem) ≤ LTippingPoint hsh :=
      NTippingPoint_le_LTippingPoint_of_mem_moves_right (A := PFreeSubset A) (.mk hAh hpfh) hsh hr_mem
        (by rw [hcase]; decide)
    by_cases hlt : NTippingPoint (Short.of_mem_moves hsh hr_mem) < NTippingPoint hsg
    · exact pf_misereOutcome_add_ge_N_of_LR hAg hpfg hAhr hpfhr hsg
        (Short.of_mem_moves hsh hr_mem) hLg hcase (Or.inl hlt)
    · have hN := (IH g hr hsg (Short.of_mem_moves hsh hr_mem) hAg hpfg hAhr hpfhr
...
omit [PropertyX A] in
private theorem lemma317_p1a_gr {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
  ...
  · by_cases hgrN : MisereOutcome gr = .N
    · have hr' : NTippingPoint hsg ≤ RTippingPoint (Short.of_mem_moves hsg hgr) := by
        apply RTippingPoint_ge_NTippingPoint_of_mem_moves_right (A := PFreeSubset A) (.mk hAg hpfg) hsg hLg hgr
      by_cases hlt : LTippingPoint hsh < RTippingPoint (Short.of_mem_moves hsg hgr)
      · exact pf_misereOutcome_add_ge_N_of_NN ( Hereditary.has_option hAg ( isOption_iff_mem_union.2 ( Or.inr hgr ) ) ) ( isPFree_of_mem_moves hpfg hgr ) hAh hpfh ( Short.of_mem_moves hsg hgr ) hsh hgrN hNh ( Or.inl hlt ) |> le_trans ( by simp +decide )
      · have hN := (IH gr h (Short.of_mem_moves hsg hgr) hsh (Hereditary.has_option hAg (isOption_iff_mem_union.2 (Or.inr hgr))) (isPFree_of_mem_moves hpfg hgr) hAh hpfh (birthday_add_lt_left (birthday_lt_of_mem_moves hgr))).p3 hgrN hNh (Or.inl (by
        exact le_antisymm ( le_of_not_gt hlt ) ( heq ▸ hr' )))
        exact hN.ge
    · rcases misereOutcome_right_option_of_L_cases hAg hpfg hsg hLg hgr with h | h
      · exact absurd h hgrL
      · exact absurd h hgrN

omit [PropertyX A] in
private theorem lemma317_p1a {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hNh : MisereOutcome h = .N)
  ...
  have hnotend : ¬ IsEndLike .right (g + h) := PFree.not_isEndLike_right_add_of_L hAg hpfg hLg
  have hopts : ∀ x ∈ moves .right (g + h), MisereOutcome x ≥ .N := by
    ...
    · exact lemma317_p1a_gr hAg hpfg hAh hpfh hsg hsh IH hLg hNh heq gr gr_mem
    · exact lemma317_hr_ge_N hAg hpfg hAh hpfh hsg hsh IH hLg heq hr hr_mem
...
private theorem lemma317_p1b {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hNh : MisereOutcome h = .N)
  ...
  have hrg2 : 2 ≤ RTippingPoint hsg := by
    ...
    have hb := NTippingPoint_lt_RTippingPoint_of_misereOutcome_L (A := PFreeSubset A) (.mk hAg hpfg) hsg hLg
    omega
  have hnotend : ¬ IsEnd .right h := by
    intro hend
    have h1 : LTippingPoint hsh = NTippingPoint hsh + 1 :=
      LTippingPoint_eq_NTippingPoint_add_one_of_isEnd_right (A := PFreeSubset A) (.mk hAh hpfh) hsh hend
  ...
  obtain ⟨hr, hr_mem, hRhr, hnhr⟩ :
    ...
    rcases isEnd_right_or_exists_NTippingPoint_eq_LTippingPoint_of_N (A := PFreeSubset A)
      (.mk hAh hpfh) hsh hNh with ⟨hend, _⟩ | h
  ...
  have hghrR : MisereOutcome (g + hr) = .R :=
    (IH g hr hsg (Short.of_mem_moves hsh hr_mem) hAg hpfg hAhr hpfhr hbd).p4c hLg hRhr
...
private theorem lemma317_p3_left {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hNg : MisereOutcome g = .N) (hNh : MisereOutcome h = .N)
    (heq : RTippingPoint hsg = LTippingPoint hsh) : WinsGoingFirst .left (g + h) := by
  rcases isEnd_left_or_exists_NTippingPoint_eq_RTippingPoint_of_N (A := PFreeSubset A)
      (.mk hAg hpfg) hsg hNg with ⟨hgend, hrg1⟩ | ⟨gl, gl_mem, hglL, hgln⟩
  · have hlh1 : LTippingPoint hsh = 1 := by rw [← heq]; exact hrg1
    ...
    · have hN := PropertyX.prop_left hAg hpfg hAh hpfh hsg hsh hNg hNh hgend hhend hrg1 hlh1
      exact (misereOutcome_N_iff_winsGoingFirst.mp hN).1
  · have hAgl : A gl := Hereditary.has_option hAg (isOption_iff_mem_union.2 (Or.inl gl_mem))
    have hpfgl : IsPFree gl := isPFree_of_mem_moves hpfg gl_mem
    have hglh : MisereOutcome (gl + h) = .L :=
      (IH gl h (Short.of_mem_moves hsg gl_mem) hsh hAgl hpfgl hAh hpfh
...
omit [ClosedUnderAdd A] [IntegerInvertible A] in
private theorem lemma317_p3 {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hNg : MisereOutcome g = .N) (hNh : MisereOutcome h = .N)
    (heq : RTippingPoint hsg = LTippingPoint hsh ∨ LTippingPoint hsg = RTippingPoint hsh) :
    MisereOutcome (g + h) = .N := by
  have IHhg : Lemma317IH (A := A) h g := fun a b ha hb hAa hpa hAb hpb hlt =>
    IH a b ha hb hAa hpa hAb hpb (lt_of_lt_of_eq hlt (add_comm _ _))
  have IHngnh : Lemma317IH (A := A) (-g) (-h) := fun a b ha hb hAa hpa hAb hpb hlt =>
    IH a b ha hb hAa hpa hAb hpb (by rw [birthday_neg, birthday_neg] at hlt; exact hlt)
  have IHnhng : Lemma317IH (A := A) (-h) (-g) := fun a b ha hb hAa hpa hAb hpb hlt =>
    IH a b ha hb hAa hpa hAb hpb
  ...
  have hL : WinsGoingFirst .left (g + h) := by
    ...
    · exact lemma317_p3_left hAg hpfg hAh hpfh hsg hsh IH hNg hNh h1
    · have hw := lemma317_p3_left hAh hpfh hAg hpfg hsh hsg IHhg hNh hNg h2.symm
      rwa [add_comm] at hw
  have hR : WinsGoingFirst .right (g + h) := by
    rcases heq with h1 | h2
    · have hw := lemma317_p3_left hAnh hpfnh hAng hpfng (Short.neg hsh) (Short.neg hsg) IHnhng
    ...
    · have hw := lemma317_p3_left hAng hpfng hAnh hpfnh (Short.neg hsg) (Short.neg hsh) IHngnh
...
omit [PropertyX A] in
private theorem lemma317_p4a_gr {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hRh : MisereOutcome h = .R)
    (heq : NTippingPoint hsg = LTippingPoint hsh) :
    ∀ gr ∈ moves .right g, MisereOutcome (gr + h) ≥ .N := by
  intro gr hgr
  have hAgr : A gr := Hereditary.has_option hAg (isOption_iff_mem_union.2 (Or.inr hgr))
  have hpfgr : IsPFree gr := isPFree_of_mem_moves hpfg hgr
  ...
  rcases misereOutcome_right_option_of_L_cases hAg hpfg hsg hLg hgr with hgrL | hgrN
  · rcases lt_or_eq_of_le hle with hlt | he
    · exact pf_misereOutcome_add_ge_N_of_LR hAgr hpfgr hAh hpfh (Short.of_mem_moves hsg hgr) hsh
        hgrL hRh (Or.inr hlt)
    · have hN := (IH gr h (Short.of_mem_moves hsg hgr) hsh hAgr hpfgr hAh hpfh
        (birthday_add_lt_left (birthday_lt_of_mem_moves hgr))).p4b hgrL hRh (Or.inr he.symm)
      exact hN.ge
  · rcases lt_or_eq_of_le hle with hlt | he
    · have hN := pf_misereOutcome_add_N_of_LTippingPoint_lt_RTippingPoint hAh hpfh hAgr hpfgr hsh
    ...
    · have hbd : birthday h + birthday gr < birthday g + birthday h := by
      ...
      have hN := (IH h gr hsh (Short.of_mem_moves hsg hgr) hAh hpfh hAgr hpfgr hbd).p2b
        hRh hgrN he
      rw [add_comm] at hN; exact hN.ge

omit [PropertyX A] in
private theorem lemma317_p4a {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hRh : MisereOutcome h = .R)
    (heq : NTippingPoint hsg = LTippingPoint hsh) : MisereOutcome (g + h) = .L := by
  have hge : MisereOutcome (g + h) ≥ .N := by
    have hlt : NTippingPoint hsh < NTippingPoint hsg := by
      have := NTippingPoint_lt_RTippingPoint_of_misereOutcome_L (A := PFreeSubset A)
        (PFreeSubset.mk (ClosedUnderNeg.neg_of hAh) (ClosedUnderNeg.neg_of (A := IsPFree) hpfh)) (Short.neg hsh)
        (by rw [misereOutcome_neg_L_iff_misereOutcome]; exact hRh)
      rw [NTippingPoint.neg hsh, RTippingPoint_neg hsh] at this
      omega
    exact pf_misereOutcome_add_ge_N_of_LR hAg hpfg hAh hpfh hsg hsh hLg hRh (Or.inl hlt)
  have hnotend : ¬ IsEndLike .right (g + h) := PFree.not_isEndLike_right_add_of_L hAg hpfg hLg
  have hopts : ∀ x ∈ moves .right (g + h), MisereOutcome x ≥ .N := by
    intro x hx
    rw [Form.moves_add, Set.mem_union] at hx
    rcases hx with ⟨gr, gr_mem, rfl⟩ | ⟨hr, hr_mem, rfl⟩
    · exact lemma317_p4a_gr hAg hpfg hAh hpfh hsg hsh IH hLg hRh heq gr gr_mem
    · exact lemma317_hr_ge_N hAg hpfg hAh hpfh hsg hsh IH hLg heq hr hr_mem
  have hwin : ¬ WinsGoingFirst .right (g + h) :=
    not_winsGoingFirst_iff.2 ⟨hnotend, fun x hx => winsGoingFirst_left_of_ge_N (hopts x hx)⟩
  rcases hc : MisereOutcome (g + h) with _ | _ | _ | _
...
omit [PropertyX A] in
private theorem lemma317_add_left_option_R_eq_L {g h hl : GameForm} (hAg : A g) (hpfg : IsPFree g)
    (hAh : A h) (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
  ...
  have hAhl : A hl := Hereditary.has_option hAh (isOption_iff_mem_union.2 (Or.inl hl_mem))
  have hpfhl : IsPFree hl := isPFree_of_mem_moves hpfh hl_mem
  rcases lt_or_eq_of_le hle with hlt | he
  · exact pf_misereOutcome_add_L_of_LTippingPoint_lt_NTippingPoint hAg hpfg hAhl hsg
  ...
  · have hbd : birthday g + birthday hl < birthday g + birthday h :=
    ...
    · exact (IH g hl hsg (Short.of_mem_moves hsh hl_mem) hAg hpfg hAhl hpfhl hbd).p1a hLg hcase
        he.symm
    · exact absurd hcase (PFree.misereOutcome_ne_P_of_pfree (A := IsPFree) hpfhl)
    · exact (IH g hl hsg (Short.of_mem_moves hsh hl_mem) hAg hpfg hAhl hpfhl hbd).p4a hLg hcase
        he.symm

omit [PropertyX A] in
private theorem lemma317_p4b_left {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hRh : MisereOutcome h = .R)
  ...
  have hnl : NTippingPoint hsh < LTippingPoint hsh :=
    NTippingPoint_lt_LTippingPoint_of_misereOutcome_R hAh hpfh hsh hRh
  have left_via_hl : ∀ (hl : GameForm) (hl_mem : hl ∈ moves .left h),
      LTippingPoint (Short.of_mem_moves hsh hl_mem) ≤ NTippingPoint hsg →
      WinsGoingFirst .left (g + h) := by
    intro hl hl_mem hle
    have hL := lemma317_add_left_option_R_eq_L hAg hpfg hAh hpfh hsg hsh IH hLg hl_mem hle
  ...
  · obtain ⟨hl, hl_mem, hlhl⟩ :=
      exists_mem_moves_left_LTippingPoint_eq_NTippingPoint (A := PFreeSubset A) (.mk hAh hpfh) hsh hRh
  ...
  · by_cases hcase : NTippingPoint hsg = RTippingPoint hsg - 1
    ...
    · obtain ⟨gl, gl_mem, hglL, hgln⟩ :=
        exists_mem_moves_left_L_NTippingPoint_eq_RTippingPoint (A := PFreeSubset A) (.mk hAg hpfg) hsg
          hLg hcase
      have hAgl : A gl := Hereditary.has_option hAg (isOption_iff_mem_union.2 (Or.inl gl_mem))
      have hpfgl : IsPFree gl := isPFree_of_mem_moves hpfg gl_mem
      have hglh : MisereOutcome (gl + h) = .L :=
...
omit [PropertyX A] in
private theorem lemma317_p4b {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hRh : MisereOutcome h = .R)
    (heq : NTippingPoint hsg = NTippingPoint hsh ∨ RTippingPoint hsg = LTippingPoint hsh) :
    MisereOutcome (g + h) = .N := by
  have hL : WinsGoingFirst .left (g + h) :=
    lemma317_p4b_left hAg hpfg hAh hpfh hsg hsh IH hLg hRh heq
  have IHnhng : Lemma317IH (A := A) (-h) (-g) := fun a b ha hb hAa hpa hAb hpb hlt =>
    IH a b ha hb hAa hpa hAb hpb
      (by rw [birthday_neg, birthday_neg, add_comm (birthday h) (birthday g)] at hlt; exact hlt)
  ...
  have hw := lemma317_p4b_left (ClosedUnderNeg.neg_of hAh) (ClosedUnderNeg.neg_of (A := IsPFree) hpfh)
    (ClosedUnderNeg.neg_of hAg) (ClosedUnderNeg.neg_of (A := IsPFree) hpfg) (Short.neg hsh)
    (Short.neg hsg) IHnhng (misereOutcome_neg_L_iff_misereOutcome.mpr hRh)
...
omit [PropertyX A] in
private theorem lemma317_p2a {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hRg : MisereOutcome g = .R) (hNh : MisereOutcome h = .N)
    (heq : NTippingPoint hsg = RTippingPoint hsh) : MisereOutcome (g + h) = .R := by
  have IHn : Lemma317IH (A := A) (-g) (-h) := fun g' h' hsg' hsh' hAg' hpfg' hAh' hpfh' hlt =>
    IH g' h' hsg' hsh' hAg' hpfg' hAh' hpfh' (by rwa [birthday_neg, birthday_neg] at hlt)
  have heqn : NTippingPoint (Short.neg hsg) = LTippingPoint (Short.neg hsh) := by
    rw [NTippingPoint.neg, LTippingPoint_neg]; exact heq
  have key := lemma317_p1a (ClosedUnderNeg.neg_of hAg) (ClosedUnderNeg.neg_of (A := IsPFree) hpfg)
    (ClosedUnderNeg.neg_of hAh) (ClosedUnderNeg.neg_of (A := IsPFree) hpfh) (Short.neg hsg)
    (Short.neg hsh) IHn (misereOutcome_neg_L_iff_misereOutcome.mpr hRg)
...
omit [ClosedUnderAdd A] [IntegerInvertible A] [PropertyX A] in
private theorem lemma317_p2b {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hRg : MisereOutcome g = .R) (hNh : MisereOutcome h = .N)
  ...
  have key := lemma317_p1b (ClosedUnderNeg.neg_of hAg) (ClosedUnderNeg.neg_of (A := IsPFree) hpfg)
    (ClosedUnderNeg.neg_of hAh) (ClosedUnderNeg.neg_of (A := IsPFree) hpfh) (Short.neg hsg)
    (Short.neg hsh) IHn (misereOutcome_neg_L_iff_misereOutcome.mpr hRg)
    (misereOutcome_neg_N_iff_misereOutcome.mpr hNh) heqn
  rw [show g + h = -((-g) + (-h)) by rw [neg_add, neg_neg, neg_neg],
...
omit [PropertyX A] in
private theorem lemma317_p4c {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) (IH : Lemma317IH (A := A) g h)
    (hLg : MisereOutcome g = .L) (hRh : MisereOutcome h = .R)
    (heq : RTippingPoint hsg = NTippingPoint hsh) : MisereOutcome (g + h) = .R := by
  have IHn : Lemma317IH (A := A) (-h) (-g) := fun g' h' hsg' hsh' hAg' hpfg' hAh' hpfh' hlt =>
    IH g' h' hsg' hsh' hAg' hpfg' hAh' hpfh'
      (by rw [birthday_neg, birthday_neg, add_comm (birthday h) (birthday g)] at hlt; exact hlt)
  ...
  have key := lemma317_p4a (ClosedUnderNeg.neg_of hAh) (ClosedUnderNeg.neg_of (A := IsPFree) hpfh)
    (ClosedUnderNeg.neg_of hAg) (ClosedUnderNeg.neg_of (A := IsPFree) hpfg) (Short.neg hsh)
    (Short.neg hsg) IHn (misereOutcome_neg_L_iff_misereOutcome.mpr hRh)
...
theorem lemma_3_17 {g h : GameForm} (hsg : IsShort g) (hsh : IsShort h)
  ...
  have IH : Lemma317IH (A := A) g h := fun g' h' hsg' hsh' hAg' hpfg' hAh' hpfh' hlt =>
    lemma_3_17 hsg' hsh' hAg' hpfg' hAh' hpfh'
  exact
    { p1a := fun hL hN heq => lemma317_p1a hAg hpfg hAh hpfh hsg hsh IH hL hN heq
      p1b := fun hL hN heq => lemma317_p1b hAg hpfg hAh hpfh hsg hsh IH hL hN heq
      p2a := fun hR hN heq => lemma317_p2a hAg hpfg hAh hpfh hsg hsh IH hR hN heq
      p2b := fun hR hN heq => lemma317_p2b hAg hpfg hAh hpfh hsg hsh IH hR hN heq
      p3 := fun hN1 hN2 heq => lemma317_p3 hAg hpfg hAh hpfh hsg hsh IH hN1 hN2 heq
      p4a := fun hL hR heq => lemma317_p4a hAg hpfg hAh hpfh hsg hsh IH hL hR heq
      p4b := fun hL hR heq => lemma317_p4b hAg hpfg hAh hpfh hsg hsh IH hL hR heq
      p4c := fun hL hR heq => lemma317_p4c hAg hpfg hAh hpfh hsg hsh IH hL hR heq }
...
-/
theorem misereOutcome_ne_P_of_propertyX {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) : MisereOutcome (g + h) ≠ .P := by
  have lr : ∀ (a b : GameForm), A a → IsPFree a → A b → IsPFree b →
      ∀ (hsa : IsShort a) (hsb : IsShort b), MisereOutcome a = .L → MisereOutcome b = .R →
      MisereOutcome (a + b) ≥ .N ∨ MisereOutcome (a + b) ≤ .N := by
    intro a b hAa hpfa hAb hpfb hsa hsb haL hbR
    rcases lt_trichotomy (NTippingPoint hsa) (NTippingPoint hsb) with h1 | h1 | h1
    · exact Or.inr (pf_misereOutcome_add_le_N_of_LR hAa hpfa hAb hpfb hsa hsb haL hbR (Or.inl h1))
    · exact Or.inl (ge_of_eq
        ((lemma_3_17 hsa hsb hAa hpfa hAb hpfb).p4b haL hbR (Or.inl h1)))
    · exact Or.inl (pf_misereOutcome_add_ge_N_of_LR hAa hpfa hAb hpfb hsa hsb haL hbR (Or.inl h1))
  have hmain : MisereOutcome (g + h) ≥ .N ∨ MisereOutcome (g + h) ≤ .N := by
    ...
    · rcases hh : MisereOutcome h with _ | _ | _ | _
      ...
      · exact absurd hh (PFree.misereOutcome_ne_P_of_pfree (A := IsPFree) hpfh)
      · exact lr g h hAg hpfg hAh hpfh hsg hsh hg hh
    · rcases hh : MisereOutcome h with _ | _ | _ | _
      · refine Or.inl ?_
        rw [add_comm]
      ...
      · rcases lt_trichotomy (LTippingPoint hsh) (RTippingPoint hsg) with h1 | h1 | h1
        · exact Or.inl (pf_misereOutcome_add_ge_N_of_NN hAg hpfg hAh hpfh hsg hsh hg hh (Or.inl h1))
        · exact Or.inl (ge_of_eq
            ((lemma_3_17 hsg hsh hAg hpfg hAh hpfh).p3 hg hh (Or.inl h1.symm)))
        · exact Or.inr (pf_misereOutcome_add_le_N_of_NN hAg hpfg hAh hpfh hsg hsh hg hh (Or.inr h1))
      · exact absurd hh (PFree.misereOutcome_ne_P_of_pfree (A := IsPFree) hpfh)
      · refine Or.inr ?_
        rw [add_comm]
        rcases OutcomeStable.misereOutcome_of_add_RN hAh hAg hh hg with h' | h'
        <;> simp +decide only [h']
    · exact absurd hg (PFree.misereOutcome_ne_P_of_pfree (A := IsPFree) hpfg)
    · rcases hh : MisereOutcome h with _ | _ | _ | _
      · have := lr h g hAh hpfh hAg hpfg hsh hsg hh hg
...
-/
theorem isPFree_of_propertyX {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h)
    (hpfh : IsPFree h) (hsg : IsShort g) (hsh : IsShort h) : IsPFree (g + h) := by
  unfold IsPFree
  refine ⟨misereOutcome_ne_P_of_propertyX hAg hpfg hAh hpfh hsg hsh, ?_⟩
  intro p x hx
  ...
  · exact isPFree_of_propertyX (Hereditary.has_option hAg (IsOption.of_mem_moves hg'))
      (isPFree_of_mem_moves hpfg hg') hAh hpfh (Short.of_mem_moves hsg hg') hsh
  · exact isPFree_of_propertyX hAg hpfg (Hereditary.has_option hAh (IsOption.of_mem_moves hh'))
      (isPFree_of_mem_moves hpfh hh') hsg (Short.of_mem_moves hsh hh')
termination_by birthday g + birthday h
decreasing_by
...
theorem isPFree_of_subset_propertyX {S A : GameForm → Prop}
    ...
    (hAS : ∀ {x}, A x → S x) (hAadd : ∀ {x y}, A x → A y → A (x + y))
    {g h : GameForm} (hAg : A g) (hpfg : IsPFree g) (hAh : A h) (hpfh : IsPFree h)
    (hsg : IsShort g) (hsh : IsShort h) :
    IsPFree (g + h) ∧ A (g + h) :=
  ⟨isPFree_of_propertyX (A := S) (hAS hAg) hpfg (hAS hAh) hpfh hsg hsh, hAadd hAg hAh⟩
